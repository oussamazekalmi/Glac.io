                ...
                <div class="card-body mt-5">
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" class="form-control ps-3 text-secondary border-0 rounded-5" value="{{ old('name') }}" autocomplete="off" />
                        </div>
                        <div style="margin: 20px 0">
                            <label class="mb-3 ms-2 text-secondary">adresse e-mail</label>
                            <input type="text" name="email" class="form-control ps-3 text-secondary border-0 rounded-5" value="{{ old('email') }}" autocomplete="off" />
                        </div>
                        <div>
